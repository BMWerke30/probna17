        ...
        @foreach($cities as $city )
            <tr>
                ...
                <td>
                    ...
                    <button type="submit" class="btn btn-primary btn-xs" onclick="return confirm('Jesteś pewien?');"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button>
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}
