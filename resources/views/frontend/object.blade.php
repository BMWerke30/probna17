    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="tab-pane fade" id="people">
            ...
            <ul class="list-inline">
                ...
                <li><a href="{{ route('person',['id'=>$user->id]) }}"><img title="{{ $user->FullName }}" class="media-object img-responsive" width="200" height="300" src="{{ $user->photos->first()->path ?? $placeholder }}" alt="..."> </a></li>
